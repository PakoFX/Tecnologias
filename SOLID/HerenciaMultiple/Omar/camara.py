from dispositivos import DiapositivoElectronico
from mixins import ConexionWiFi, BateriaRecargable, SensorMovimiento

class CamaraSeguridadInalambrica(DiapositivoElectronico, ConexionWiFi, SensorMovimiento, BateriaRecargable):

    def __init__(self, marca, modelo):
        DiapositivoElectronico.__init__(self, marca, modelo)
